...
import type { ApiErrorResponse, ApiItemResponse, Job } from "@/types";
...
export async function PATCH(
  ...
  // Only allow a known subset of fields to be updated.
  const {
    name,
    source_type,
    raw_request,
  ...
  if (parsed_request !== undefined) updates.parsed_request = parsed_request;
